...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://condominiumgw.condominium.condominium.com"
        echo "#####################################################"
}
...
default() {
    ...
    kubectl apply -f condominiumgw-${suffix}/
    kubectl apply -f managerms-${suffix}/
    kubectl apply -f paymentms-${suffix}/
