...
```
$ docker image tag condominiumgw jarango71/condominiumgw
$ docker push jarango71/condominiumgw
$ docker image tag managerms jarango71/managerms
$ docker push jarango71/managerms
$ docker image tag paymentms jarango71/paymentms
$ docker push jarango71/paymentms
```
...
```
$ kubectl get svc condominiumgw -n condominium
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n condominium
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n condominium
```
