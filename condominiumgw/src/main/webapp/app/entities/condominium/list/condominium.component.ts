...
export class CondominiumComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.condominiumService
      ...
      .subscribe({
        next: (res: HttpResponse<ICondominium[]>) => {
  ...
  trackId(_index: number, item: ICondominium): number {
    return item.id!;
  }

  delete(condominium: ICondominium): void {
    const modalRef = this.modalService.open(CondominiumDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.condominium = condominium;
  ...
  protected onSuccess(data: ICondominium[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
