...
describe('Condominium Management Component', () => {
  let comp: CondominiumComponent;
  let fixture: ComponentFixture<CondominiumComponent>;
  let service: CondominiumService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'condominium', component: CondominiumComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CondominiumComponent, '')
      .compileComponents();
