...
export class CuotaComponent implements OnInit {
  ...
  trackId(_index: number, item: ICuota): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICuota[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
