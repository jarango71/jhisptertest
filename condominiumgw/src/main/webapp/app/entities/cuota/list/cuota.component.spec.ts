...
describe('Cuota Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cuota', component: CuotaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cuotas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
